...
public class AsyncTaskElevation extends AsyncTask<Void, Void, String> {
    public ArrayList<OnCompleteListenerAsync> listeners;
    private HashMap<String, String> myParams;
    private Context myContext;
    private String url;

    public AsyncTaskElevation(Context myContext, HashMap<String, String> myParams) {
    ...
    protected String doInBackground(Void... arg0) {
        return performPostCall("https://maps.googleapis.com/maps/api/elevation/json?", myParams); //Call the webservice
    }
